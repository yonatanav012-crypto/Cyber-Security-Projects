...
### 1. Hunter: Live Network Forensics & Threat Detection (Bash)
An advanced, automated network forensics and threat detection tool developed for live traffic monitoring.
* **Key Features:** Integrates Tshark for real-time packet analysis, dynamically pulls Threat Intelligence Feeds (IOCs), automatically extracts transferred files (<1MB) from PCAPs, and cross-references SHA-256 signatures with the VirusTotal API.
* **Files:** `7736-39.s20.NX216.sh` | `7736-39.s20.NX216.pdf`

### 2. Log Recon Analyzer (Python)
...
### 3. Forensics Analyzer: HDD & Memory (Bash)
...
### 4. CHECKER: SOC Automated Attack Simulator (Bash)
...
### 5. Operation Domain Mapper: Automated AD Enumeration (Bash)
...
* **Files:** `7736-39.s20.zx305.sh` | `7736-39.s20.zx305.pdf`

### 6. TITAN: Network Vulnerability Scanner (Bash)
...
* **Files:** `7736-39.S25.zx301.sh` | `7736-39.S25.zx301.pdf`

---

## 🕵️ Reconnaissance & OSINT

### 7. Lightning Remote Scanner (Bash)
...
* **Files:** `7736-39.s20.nx201.sh` | `7736-39.s20.nx201.pdf`

### 8. Darknet Crawler Automation (Bash)
...
### 9. Net Crafts Automation (Network Mapping)
An automated network mapping and external information gathering report.
